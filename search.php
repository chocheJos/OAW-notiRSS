...
if($_POST){
  ...
  if (empty($busqueda)){
   $texto = '
   <div class=" text-center jumbotron"><h4>NO SE ENCONTARON RESULTADOS EN LA BD</h4></div>
    ...
    if (@mysqli_num_rows($resultado) > 0){ 
     ...
     while($fila = mysqli_fetch_assoc($resultado)){ 
      ...
      $texto = '
         <div class=" text-center jumbotron"><h4>NO HAY RESULTADOS EN LA BASE DE DATOS</h4></div>
         </div></div></div></div></br></br>'; 
    }
